...
describe('readMusHead', function () {
    it('correctly parses and returns a Mus file header', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sizeOfWord, expectedInstruments, file, buffer, context, actual;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fs_1.promises.readFile(path.join(__dirname, '../e1m1.mus'))];
                case 1:
                    file = _a.sent();
                    ...
                    actual = readMusHead_1.readMusHead(context);
